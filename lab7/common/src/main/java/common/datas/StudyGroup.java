...
public class StudyGroup implements Comparable<StudyGroup> {
    ...
    public StudyGroup(Long id, String name, Coordinates coordinates, LocalDate creationDate, Long studentsCount, long transferredStudents, FormOfEducation formOfEducation, Semester semesterEnum, Person groupAdmin,String userName) {
        this.id = id;
        this.name = name;
